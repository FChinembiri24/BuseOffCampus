            ...
            child: Stack(
              ...
              Positioned(
                  child: Container(
                    width: 50,
                    height: 50,
                    decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(25)), color: Colors.blue[200]),
                    child: IconButton(
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Text("400RTGS /Semester",
                                style: TextStyle(fontSize: 22,color: Colors.blue[200], fontWeight: FontWeight.bold), ),
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            SizedBox(width: 4,),
                            Text("2 people", style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.w500),)
                          ],
                        ),
                        Row(
                          children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            SizedBox(width: 4,),
                            Text("1 Bathrooms", style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.w500),)
                          ],
                        ),
                      ],
                    ),
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text("Frank Chinembiri", style: TextStyle(color: Colors.grey[800], fontSize : 18, fontWeight: FontWeight.w600),),
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                Icon(Icons.wifi, color:  Colors.blue[200],),
                                SizedBox(width: 4,),
                            ...
                            Row(
                              children: <Widget>[
                                Icon(Icons.local_offer, color:  Colors.blue[200],),
                                SizedBox(width: 4,),
                            ...
                            Row(
                              children: <Widget>[
                                Icon(Icons.videogame_asset, color:  Colors.blue[200],),
                                SizedBox(width: 4,),
                                Text("Stove", style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.w500),)
                              ],
                            ),
                          ],
                        ),
